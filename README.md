...
To make the matter worse, most likely, you will face coding challenge along the way, with every one interviewing you (usually, 3-4 rounds). It seems to me interviewers (software engineers themselves) do not have the time to prepare for interview, so, instead of asking intelligent questions to see if a candidate fits to the specific job opening based on the candidate's past experience, they have a lazy tendency of throwing a couple of coding challenges and watch a candidate struggling with the challenge. Is it fair for a candidate to go through repetitive coding challenges again and again after they already passed it? This makes the interview process an exshautive process for the job candidates as they have to spend several days to prepare for every round of interview as I did. In one occasion, I called it quit after the third interviewer attempts to challenge me on coding. It is just simply ridiculous and a proof of unfairness and disrespect to a job applicant. Do I want to with for or with these kinds of people? Nope. Even if they offer me a job and I'd take it out of necessity, I would leave them as  soon as a better opportunity arises.
